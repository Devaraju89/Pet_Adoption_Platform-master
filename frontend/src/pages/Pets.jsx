...
import { petsAPI, userAPI } from '../services/api';
...
export default function Pets() {
  ...
  const [favorites, setFavorites] = useState(new Set()); // Store fav IDs
  const [loading, setLoading] = useState(true);
  const [visibleCards, setVisibleCards] = useState(new Set());
  const [favLoading, setFavLoading] = useState(false); // Valid definition
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {speciesCategories.map((species, index) => (
              <button
                ...
                className={`relative px-8 py-4 rounded-xl font-bold text-base transition-all duration-300 transform hover:scale-105 overflow-hidden ${selectedSpecies === species.key
              ...
              {currentPets.map((pet, index) => {
                ...
                return (
                  <article
                    ...
                    className={`bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-700 transform hover:-translate-y-3 hover:scale-105 group ${isVisible
                  ...
                  >
                    ...
                    <div className="relative w-full h-64 bg-gradient-to-br from-pink-100 to-purple-100 overflow-hidden">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.target.src = "https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=400"; // Fallback generic pet image
                        }}
                        className={`w-full h-full object-cover transition-all duration-700 ${isVisible
                      ...
                      <div className={`absolute top-3 left-3 transition-all duration-500 ${isVisible
                      ...
                      <div className={`absolute top-3 right-3 transition-all duration-500 ${isVisible
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-bold shadow-lg backdrop-blur-sm ${pet.adoptionStatus === 'available' ? 'bg-green-500/90 text-white' :
                    ...
                    <div className="p-5">
                      <div className="mb-4">
                        <h3 className={`text-xl font-black text-gray-900 mb-1 group-hover:text-pink-600 transition-all duration-500 ${isVisible
                        ...
                        <p className={`text-sm text-gray-500 font-medium transition-all duration-500 ${isVisible
                          ? 'opacity-100 translate-y-0'
                          : 'opacity-0 translate-y-4'
                          }`}
                          style={{
                      ...
                      <div className={`flex gap-3 transition-all duration-500 ${isVisible
                        ? 'opacity-100 translate-y-0'
