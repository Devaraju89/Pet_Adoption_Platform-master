      ...
      <div className="border-b border-gray-200">
        <nav className="flex">
          <button
            ...
            className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === "records"
          ...
          <button
            ...
            className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === "vaccinations"
                ? "border-pink-500 text-pink-600"
                : "border-transparent text-gray-500 hover:text-gray-700"
              }`}
          >
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${getRecordTypeColor(record.recordType)}`}>
                          {(record.recordType || 'Other').charAt(0).toUpperCase() + (record.recordType || 'Other').slice(1)}
                        </span>
                      </div>
                    </div>
